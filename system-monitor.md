...
| <img loading="lazy" src="icons/system-monitoring-center.png" width="48" height="48"><span class="arch-data" data-arch="x86_64 aarch64" hidden></span> | [***system-monitoring-center***](apps/system-monitoring-center.md) | *Multi-featured system monitor.*..[ *read more* ](apps/system-monitoring-center.md)*!* | [*blob*](https://github.com/ivan-hc/AM/blob/main/programs/x86_64/system-monitoring-center) **/** [*raw*](https://raw.githubusercontent.com/ivan-hc/AM/main/programs/x86_64/system-monitoring-center) |
