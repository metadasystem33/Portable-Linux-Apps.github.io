...
| <img loading="lazy" src="icons/animeko.png" width="48" height="48"> | [***animeko***](apps/animeko.md) | *集找番、追番、看番的一站式弹幕追番平台，云收藏同步 (Bangumi)，离线缓存，BitTorrent，弹幕云过滤。100% Kotlin/Compose Multiplatform.*..[ *read more* ](apps/animeko.md)*!* | [*blob*](https://github.com/ivan-hc/AM/blob/main/programs/x86_64/animeko) **/** [*raw*](https://raw.githubusercontent.com/ivan-hc/AM/main/programs/x86_64/animeko) |
